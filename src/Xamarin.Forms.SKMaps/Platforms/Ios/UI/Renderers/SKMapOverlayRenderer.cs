...
using Xamarin.Forms.SKMaps.WeakSubscription;
using static Xamarin.Forms.SKMaps.SKMapOverlay;

namespace Xamarin.Forms.SKMaps.Platforms.Ios.UI.Renderers
{
    internal class SKMapOverlayRenderer : MKOverlayRenderer
    {
        private SKMapKitOverlay _NativeOverlay => Overlay as SKMapKitOverlay;
